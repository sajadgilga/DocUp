...
class MenuItem extends MenuItemProvider {
  ...
  MenuItem(
      {this.title, this.child, this.userInfo, this.textStyle, this.textAlign});

  @override
  Widget get menuImage => child;
...
//        },
  ...
  Widget _createMenuItem(MenuItemProvider item, bool showLine, double itemWidth,
      double itemHeight) {
