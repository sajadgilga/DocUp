...
import 'package:Neuronio/ui/panel/screening/AutoGeneratedReport.dart';
...
class NavigatorRoutes {
  ...
  static const String screeningAutoGeneratedReport =
      "/screeningAutoGeneratedReport";
    ...
    switch (widget.index) {
      ...
      case 1:
        return {
          ...
          NavigatorRoutes.screeningAutoGeneratedReport: (context) =>
              _autoGeneratedReport(context, param1),
          NavigatorRoutes.myPartnerDialog: (context) =>
              _myPartnerDialog(context, param1),
...
//  }
    ...
    return BlocBuilder<EntityBloc, EntityState>(
      ...
      return BlocBuilder<PanelSectionBloc, PanelSectionSelected>(
        builder: (context, state) {
          // TODO: we may need to change the main object in bloc and not use copy, due to some change in customer journey
                  ...
                  pages: [
                    [
                      InfoPage(
                        ...
                        pageName: InAppStrings.doctorAdvice,
                        picListLabel: InAppStrings.panelDoctorAdvicePicLabel,
                        lastPicsLabel:
                            InAppStrings.panelDoctorAdvicePicListLabel,
                        emptyFilesLabel:
                            InAppStrings.emptyPanelDoctorAdviceFiles,
                        uploadLabel:
                            InAppStrings.panelDoctorAdvicePicUploadLabel,
                      )
                    ],
                    [
                      InfoPage(
                        ...
                        pageName: InAppStrings.prescriptions,
                        picListLabel: InAppStrings.panelPrescriptionsPicLabel,
                        lastPicsLabel:
                            InAppStrings.panelPrescriptionsPicListLabel,
                        emptyFilesLabel: InAppStrings.emptyPrescriptionFiles,
                        uploadLabel: InAppStrings.panelPrescriptionsUploadLabel,
                      )
                    ],
                    [
                      InfoPage(
                        ...
                        pageName: InAppStrings.testResults,
                        picListLabel: InAppStrings.panelTestResultsPicLabel,
                        lastPicsLabel:
                            InAppStrings.panelTestResultsPicListLabel,
                        emptyFilesLabel: InAppStrings.emptyTestFiles,
                        uploadLabel:
                            InAppStrings.panelTestResultsPicUploadLabel,
                      )
                    ],
                  ],
                ));
  ...
  Widget _panel(context, {detail, extraDetail}) {
    if (detail != null)
      switch (detail) {
        case "chat":
          _panelSectionBloc.add(PanelSectionSelect(
  ...
  Widget _screeningDoctorSelectionPage(context, extraDetail) {
    return BlocProvider.value(
      ...
      child: ScreeningDoctorSelectionPage(
        onPush: (direction, userEntity, screeningId, visitSource) {
          push(context, direction,
...
//   }
  ...
  Widget _autoGeneratedReport(context, int param1) {
    return AutoGeneratedReport(
      onPush: (direction, p1, p2, p3, returnCallBack) {
        push(context, direction, param1: p1);
      },
      screeningStepId: param1,
    );
  }
  ...
  _visitConf(BuildContext context, DoctorEntity entity) {
  ...
  _doctorProfileMenuPage(BuildContext context, DoctorEntity entity) {
  ...
  _patientProfileMenuPage(BuildContext context, PatientEntity entity) {
