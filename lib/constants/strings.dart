...
//
  ...
  static final String navigationBarDescription =
      "از اینجا می تونی بین خانه، پنل کاربری، خدمات و پروفایل جابجا بشوید." +
          "\n" +
          " صفحه‌ی خانه، جایی هست که می توانید بنر ها و نوتیفیکیشن ها رو مشاهده کنید،" +
          "\n" +
          " پنل کاربری جایی هست که کارای اصلی مربوط به سلامت و ارتباط با پزشک اونجا انجام می شود،" +
          "\n" +
          " و در صفحه خدمات هم، خدمات کلینیک نمایش داده می شود،" +
          "\n" +
          " و در آخر، صفحه پروفایل، اطلاعات کاربری و اطلاعات دیگری مثل قد، شهر، تاریخ تولد ... قابل ویرایش هستند که برای پرونده سلامت شما لازم هستند.";
